...
Public Class SueldosConceptosMasivo
...
#Region "Eventos"
   ...
   Private Sub tsbEliminarConceptosMasivo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsbEliminarConceptosMasivo.Click
      Try
   ...
   Private Sub tsbGrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsbGrabar.Click
      ...
      Try
         ...
         oMovimientos.ActualizarConceptosDelPersonal(ListaDatos)
...
#Region "Metodos"
   ...
   Private Sub CargarDatosConcepto(ByVal dr As DataGridViewRow)
      ...
      'Me.chbEsContempladoAguinaldo.Checked = Boolean.Parse(dr.Cells("EsContempladoAguinaldo").Value)
