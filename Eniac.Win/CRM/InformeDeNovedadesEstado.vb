Public Class InformeDeNovedadesEstado
...
#End Region
   ...
   Public Function GetParametrosDisponibles() As String Implements IConParametros.GetParametrosDisponibles
      ...
      stb.AppendFormatLine("Definir el tipo de Tipo de Novedad para usar en la pantalla.")
      stb.AppendFormatLine("Por defecto: ''")
...
#Region "Overrides"
   ...
   Protected Overrides Sub OnLoad(e As System.EventArgs)
      ...
      Try
         ...
         Me._publicos.CargaComboDesdeEnum(cmbTipoFechaFiltro, GetType(Entidades.CRMNovedad.TipoFechaFiltro), hideBrowsable:=False, category:="CambioEstado")
         ...
         cmbTipoFechaFiltro.SelectedValue = If(TipoFechaFiltro.HasValue, TipoFechaFiltro.Value, Entidades.CRMNovedad.TipoFechaFiltro.FechaCambioEstado)
...
#Region "Eventos"
   ...
   Private Sub UltraGridPrintDocument1_PagePrinting(sender As System.Object, e As Infragistics.Win.Printing.PagePrintingEventArgs)
   ...
   Private Sub ugDetalle_InitializeRow(sender As Object, e As InitializeRowEventArgs) Handles ugDetalle.InitializeRow
      Try
         ...
         If e.Row IsNot Nothing Then
            If IsNumeric(e.Row.Cells("ColorEstadoCambioEstado").Value) Then
               Dim color = Drawing.Color.FromArgb(Integer.Parse(e.Row.Cells("ColorEstadoCambioEstado").Value.ToString()))
               e.Row.Cells("NombreEstadoCambioEstado").Color(Nothing, color)
            End If
...
#Region "Metodos"
   ...
   Private Sub CargaGrillaDetalle()
      ...
      dtDetalle = oCRM.GetNovedadesCambioEstado(dtpDesde.Value, dtpHasta.Value, filtroFecha, TipoNovedadParametro.IdTipoNovedad, Nothing,
                                  idCategoriaNovedad, idEstadoNovedad, IdUsuarioAsignado, IdMedioComunicacionNovedad, If(chbMetodoResolucion.Checked, cmbMetodoResolucion.ValorSeleccionado(Of Integer), 0),
                                  ...
                                  visualizaSucursal:=Nothing, If(chbVehiculo.Checked, bscCodigoVehiculo.Text, String.Empty))
   ...
   Public Sub FormatearGrilla()
      ...
      With ugDetalle.DisplayLayout.Bands(0)
         pos = .Columns(Entidades.CRMNovedad.Columnas.Interlocutor.ToString()).Header.VisiblePosition - 1
         .Columns("IdEstadoCambioEstado").OcultoPosicion(True, pos)
         .Columns("NombreEstadoCambioEstado").FormatearColumna("Estado Cambio", pos, 100)
         .Columns("FechaCambioEstado").FormatearColumna("Fecha / Hora Cambio", pos, 120, HAlign.Center, hidden:=True, "dd/MM/yyyy HH:mm:ss")
         .Columns("FechaCambioEstado_Fecha").FormatearColumna("Fecha Cambio", pos, 80, HAlign.Center)
         .Columns("FechaCambioEstado_Hora").FormatearColumna("Hora Cambio", pos, 60, HAlign.Center)
         .Columns("UsuarioCambioEstado").FormatearColumna("Usuario Cambio", pos, 70)
         .Columns("UsuarioAsignadoCambioEstado").FormatearColumna("Usuario Asignado Cambio", pos, 70)
      End With
