Public Class MFRubrosCompras

   Public Const TipoFiltroKey As String = "RUBROSCOMPRAS"

#Region "Campos"

   Private _filtros As List(Of Entidades.RubroCompra)
   Public ReadOnly Property Filtros() As List(Of Entidades.RubroCompra)
      Get
         Return _filtros
      End Get
   End Property
...
#Region "Constructores"
   ...
   Public Sub New(permiteSinSeleccion As Boolean)
      ...
      _filtros = New List(Of Entidades.RubroCompra)()
...
#Region "Overrides"
   ...
   Public Shared Function GetTodos() As List(Of Entidades.RubroCompra)
      Dim reg As Reglas.RubrosCompras = New Reglas.RubrosCompras()
      Return reg.GetTodos()
   End Function
...
#Region "Eventos"
   ...
   Private Sub bscCodigo_BuscadorClick() Handles bscCodigo.BuscadorClick
      TryCatched(
         Sub()
            ...
            bscCodigo.Datos = New Reglas.RubrosCompras().GetPorCodigo(cod)
         End Sub)
   End Sub
   Private Sub bscNombre_BuscadorClick() Handles bscNombre.BuscadorClick
      TryCatched(
         Sub()
            ...
            bscNombre.Datos = New Reglas.RubrosCompras().GetPorNombre(bscNombre.Text.Trim())
         End Sub)
   End Sub
   ...
   Private Sub btnInsertar_Click(sender As Object, e As EventArgs) Handles btnInsertar.Click
      Try
         If Not (Me.bscCodigo.Selecciono Or Me.bscNombre.Selecciono) Then
            Exit Sub
         End If
         Dim ep As Entidades.RubroCompra = New Entidades.RubroCompra()
   ...
   Private Sub btnEliminar_Click(sender As Object, e As EventArgs) Handles btnEliminar.Click
      Try
         ...
         For Each pr As Entidades.RubroCompra In Me._filtros
