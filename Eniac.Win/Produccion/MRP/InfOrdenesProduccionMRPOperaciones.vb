Public Class InfOrdenesProduccionMRPOperaciones
#Region "Campos"
...
#Region "Overrides"
   ...
   Protected Overrides Sub OnLoad(e As EventArgs)
      ...
      Sub()
         ...
         ugDetalle.AgregarFiltroEnLinea({"NombreProducto", "NombreCliente"})
...
#Region "Metodos"
   ...
   Private Sub ValidaCargaGrillaDetalle(err As Entidades.ErrorBuilder)
      ...
      If chbCodigoOperacion.Checked AndAlso String.IsNullOrWhiteSpace(txtCodigoOperacion.Text) Then
         err.AddError("ATENCION: NO seleccionó u`na Operación aunque activó ese Filtro.", txtCodigoOperacion)
      End If
   ...
   Private Sub CargaGrillaDetalle()
      ...
      Dim dtDetalle = rOP.GetInformeOperaciones(idEstado, codigoProcProdOperacion, fechaDesde, fechaHasta,
