Public Class InfNovedadesProduccionMRPTiempos
#Region "Campos"
...
#Region "Overrides"
   ...
   Protected Overrides Sub OnLoad(e As EventArgs)
      ...
      Sub()
         ...
         _publicos.CargaComboDesdeEnum(cmbTipoDeclaracion, Reglas.Publicos.TipoOperacionesTiempos.PUESTAPUNTO)
         _publicos.CargaComboConceptosNoProductivo(cmbConceptoNoProductivo)

         '-- Inicializa Campos de Busqueda.- --
         RefrescarDatos()

         ugDetalle.AgregarFiltroEnLinea({"NombreProducto", "DescripcionProceso", "NombreCliente"})
         ugDetalle.AgregarTotalesSuma({"HorasReportadas"})
...
#End Region
   ...
   End Sub
   Private Sub chbTipoDeclaracion_CheckedChanged(sender As Object, e As EventArgs) Handles chbTipoDeclaracion.CheckedChanged
      TryCatched(Sub() chbTipoDeclaracion.FiltroCheckedChanged(cmbTipoDeclaracion))
   End Sub
   Private Sub chbConceptoNoProductivo_CheckedChanged(sender As Object, e As EventArgs) Handles chbConceptoNoProductivo.CheckedChanged
      TryCatched(Sub() chbConceptoNoProductivo.FiltroCheckedChanged(cmbConceptoNoProductivo))
   End Sub
...
#Region "Metodos"
   Private Sub RefrescarDatos()
      ...
      chbTipoDeclaracion.Checked = False
      chbConceptoNoProductivo.Checked = False
   ...
   Private Sub ValidaCargaGrillaDetalle(err As Entidades.ErrorBuilder)
      ...
      End If
      If chbTipoDeclaracion.Checked AndAlso cmbTipoDeclaracion.SelectedIndex < 0 Then
         err.AddError("ATENCION: NO seleccionó un Tipo de Declaración aunque activó ese Filtro.", cmbTipoDeclaracion)
      End If
      If chbConceptoNoProductivo.Checked AndAlso cmbConceptoNoProductivo.SelectedIndex < 0 Then
         err.AddError("ATENCION: NO seleccionó un Concepto No Productivo aunque activó ese Filtro.", cmbConceptoNoProductivo)
      End If
   ...
   Private Sub CargaGrillaDetalle()
      ...
      Dim idTipoDeclaracion = cmbTipoDeclaracion.ValorSeleccionado(Of Reglas.Publicos.TipoOperacionesTiempos?)(chbTipoDeclaracion, Nothing)
      Dim idConcepto = cmbConceptoNoProductivo.ValorSeleccionado(chbConceptoNoProductivo, 0I)
   ...
   Private Function CargarFiltrosImpresion() As String
      ...
      With filtro
         ...
         AgregarFiltro(filtro, chbTipoDeclaracion, cmbTipoDeclaracion)
         AgregarFiltro(filtro, chbConceptoNoProductivo, cmbConceptoNoProductivo)
