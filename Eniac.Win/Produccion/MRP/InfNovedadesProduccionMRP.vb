Public Class InfNovedadesProduccionMRP
#Region "Campos"
...
#Region "Overrides"
   ...
   Protected Overrides Sub OnLoad(e As EventArgs)
      ...
      Sub()
         ...
         ugDetalle.AgregarTotalesSuma({"TotalHorasReportadas"})
...
#Region "Metodos"
   ...
   Private Sub ValidaCargaGrillaDetalle(err As Entidades.ErrorBuilder)
      ...
      If chbTarea.Checked And Not bscNombreTareas.Selecciono Then
         err.AddError("ATENCION: NO seleccionó una Tarea aunque activó ese Filtro.", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Information)
         Exit Sub
      End If
   End Sub
   Private Sub CargaGrillaDetalle()
      Dim idResponsable = cmbResponsable.ValorSeleccionado(chbResponsable, 0I)
      Dim codigoOperacion = txtCodigoOperacion.ValorSeleccionado(chbCodigoOperacion, String.Empty)
