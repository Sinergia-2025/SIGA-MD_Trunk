...
Public Class PrestarProducto
   ...
   Protected Overrides Function GetReglas() As Eniac.Reglas.Base
      Return New Eniac.Reglas.RecepcionNotas()
   End Function
   ...
   Private Sub bscCodigoProducto_BuscadorSeleccion(ByVal sender As Object, ByVal e As Controles.BuscadorEventArgs) Handles bscCodigoProducto.BuscadorSeleccion
      Try
         If Not e.FilaDevuelta Is Nothing Then
            ...
            DirectCast(Me._entidad, Eniac.Entidades.RecepcionNota).ProductoPrestado = New Eniac.Reglas.Productos().GetUno(e.FilaDevuelta.Cells("IdProducto").Value.ToString.Trim())
