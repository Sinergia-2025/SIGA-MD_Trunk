...
#Region "Constructores"
   ...
   Public Sub New(ByVal notaRecepcion As Eniac.Entidades.RecepcionNotaProveedor)
...
#Region "Overrides"
   ...
   Protected Overrides Function GetReglas() As Eniac.Reglas.Base
      Return New Reglas.RecepcionNotasProveedores()
   End Function
   ...
   Private Sub bscProveedor_BuscadorSeleccion(ByVal sender As Object, ByVal e As Controles.BuscadorEventArgs) Handles bscProveedor.BuscadorSeleccion
      Try
         If Not e.FilaDevuelta Is Nothing Then
            ...
            DirectCast(Me._entidad, Eniac.Entidades.RecepcionNotaProveedor).Proveedor = New Eniac.Reglas.Proveedores().GetUno(Long.Parse(e.FilaDevuelta.Cells("IdProveedor").Value.ToString()))
