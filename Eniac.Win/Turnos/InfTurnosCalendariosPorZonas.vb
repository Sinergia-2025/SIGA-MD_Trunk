...
#End Region
Public Class InfTurnosCalendariosPorZonas
...
#End Region
   ...
   Private Sub chkExpandAll_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkExpandAll.CheckedChanged
      ...
      End If
   End Sub
   Private Sub chbZonas_CheckedChanged(sender As Object, e As EventArgs) Handles chbZonas.CheckedChanged
      Me.bscCodigoZona.Enabled = Me.chbZonas.Checked
      Me.bscZonas.Enabled = Me.chbZonas.Checked

      If Me.chbZonas.Checked Then
         Me.bscCodigoZona.Focus()
      Else
         Me.bscCodigoZona.Text = String.Empty
         Me.bscZonas.Text = String.Empty
      End If
   ...
   Private Sub bscCodigoZona_BuscadorClick() Handles bscCodigoZona.BuscadorClick
      Try
         ...
         Me.bscCodigoZona.Datos = oProductos.GetPorCodigo(Me.bscCodigoZona.Text.Trim(), actual.Sucursal.Id, Publicos.ListaPreciosPredeterminada, "TODOS", False, "Normal", False, Entidades.Producto.TiposOperaciones.NORMAL, , True, True, rubro)
      Catch ex As Exception
         MessageBox.Show(ex.Message, Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Information)
      End Try
   End Sub
...
#Region "Metodos"
   ...
   Protected Overridable Sub CargarFiltrosParaConsulta(filtros As Entidades.Filtros.GetPorRangoFechasFiltros)
      ...
      End If
      If Me.chbZonas.Checked Then
         filtros.idProducto = bscCodigoZona.Text
      End If
   ...
   Private Sub CargaGrillaDetalle()
      ...
      Try
         ...
         dtDetalle = clTurnos.GetPorRangoFechasZonas(filtros)
   ...
   End Function
   Private Sub CargarZonas(ByVal dr As DataGridViewRow)
      ...
      '   Return
      'End If
      'If Me.bscNombreCliente.Text.Trim().Length = 0 Then
      '   ShowMessage("Falta cargar el Nombre del cliente.")
      '   Me.bscNombreCliente.Focus()
      '   Return
      'End If

      'If bscNombreCliente.Tag Is Nothing Then
