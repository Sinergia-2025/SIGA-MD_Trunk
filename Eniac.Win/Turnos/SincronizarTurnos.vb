Public Class SincronizarTurnos
   ...
   Protected Overrides Sub OnLoad(e As EventArgs)
      MyBase.OnLoad(e)
      Try
         txtURLServicio.Text = String.Format("{0}", Reglas.Publicos.SimovilTurnosURLBase)
...
#Region "BackgroudWorker"
   ...
   Private Sub bkgSincronizar_DoWork(sender As Object, e As System.ComponentModel.DoWorkEventArgs) Handles bkgSincronizar.DoWork
      Try
         Dim rSincronizar As New Reglas.ServiciosRest.Turnos.SincronizarTurnos()
         AddHandler rSincronizar.Avance, Sub(sender1 As Object, e1 As Reglas.ServiciosRest.SincronizacionEventArgs)
                                            bkgSincronizar.ReportProgress(0, e1.Mensaje)
                                         End Sub
         rSincronizar.ImportarAutomaticamente()
