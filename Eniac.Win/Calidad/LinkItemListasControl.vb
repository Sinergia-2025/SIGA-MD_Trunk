...
Option Explicit On
Imports System.IO
Public Class LinkItemListaControl
...
#Region "Constructores"
   ...
   Public Sub New()
      ...
      InitializeComponent()
   End Sub
   Public Sub New(entidad As Entidades.ListaControlItemLinks)
      Me.InitializeComponent()
      _entidad = DirectCast(entidad, Entidades.ListaControlItemLinks)
...
#End Region
   ...
   Private ReadOnly Property Link As Entidades.ListaControlItemLinks
      Get
         Return DirectCast(Me._entidad, Eniac.Entidades.ListaControlItemLinks)
      End Get
   End Property
...
#Region "Overrides"
   ...
   Protected Overrides Sub OnLoad(ByVal e As System.EventArgs)
      ...
      If StateForm = Win.StateForm.Insertar Then
         Dim oLink As Reglas.ListasControlItemsLinks = New Reglas.ListasControlItemsLinks()
         Link.ItemLink = oLink.GetCodigoMaximo(Link.IdListaControl, Link.Item) + 1
      End If
   ...
   Protected Overrides Function GetReglas() As Eniac.Reglas.Base
      Return New Eniac.Reglas.ListasControlItemsLinks()
   End Function
