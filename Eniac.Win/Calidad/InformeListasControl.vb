...
#End Region
Public Class InformeListasControl
...
#Region "Overrides"
   ...
   Protected Overrides Sub OnLoad(ByVal e As System.EventArgs)
      ...
      Try
         ...
         Me._publicos.CargaComboTiposListasControl(Me.cmbTipoListaControl)
...
#End Region
   ...
   Private Sub chbTipoLista_CheckedChanged(sender As Object, e As EventArgs) Handles chbTipoLista.CheckedChanged
      Try
         Me.cmbTipoListaControl.Enabled = Me.chbTipoLista.Checked
         If Not Me.chbTipoLista.Checked Then
            Me.cmbTipoListaControl.SelectedIndex = -1
         Else
            If Me.cmbTipoListaControl.Items.Count > 0 Then
               Me.cmbTipoListaControl.SelectedIndex = 0
            End If
            Me.cmbTipoListaControl.Focus()
         End If
...
#Region "Metodos"
   ...
   Private Sub CargarGrillaDetalle()
      ...
      Dim TipoListaControl As Integer = 0
      Dim Ubicacion As String = String.Empty

      If chbEstado.Checked Then
         Estado = Integer.Parse(cmbEstadoCalidad.SelectedValue.ToString())
      End If
      ...
      If chbTipoLista.Checked Then
         TipoListaControl = Integer.Parse(cmbTipoListaControl.SelectedValue.ToString())
      End If
      ...
      _dtListasDetalle = New Reglas.ListasControlProductos().GetListasControlProductos(If(chbProducto.Checked, bscCodigoProducto2.Text, String.Empty),
                                                                                     dtpDesde.Value, dtpHasta.Value, Estado,
                                                                                      chbFechaLiberado.Checked, chbFechaEntregado.Checked,
                                                                                      ListaControl, TipoListaControl,
      ...
      For Each dr As UltraGridRow In ugDetalle.Rows
         ColorEstado = New Reglas.EstadosListasControl().GetEstadoColorPorNombre(dr.Cells("NombreEstadoCalidad").Value.ToString())
         ...
         If Not Boolean.Parse(dr.Cells("CalidadStatusEntregado").Value.ToString()) Then
            dr.Cells("CalidadStatusEntregado").Appearance.BackColor = Drawing.Color.LightCoral
         End If
      Next
