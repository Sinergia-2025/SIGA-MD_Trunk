...
#Region "Metodos"
   ...
   Private Sub CargarGrillaDetalle()
      ...
      _dtListasDetalle = New Reglas.ListasControlProductos().GetInformeLeadTime(If(chbProducto.Checked, bscCodigoProducto2.Text, String.Empty),
                                                                                     dtpDesde.Value, dtpHasta.Value, Estado,
                                                                                      ListaControl, If(chbCliente.Checked, bscCodigoCliente.Tag.ToString().ValorNumericoPorDefecto(0L), 0L),
                                                                                      Ubicacion)
