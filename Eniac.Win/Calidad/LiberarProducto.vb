...
#Region "Overrides"
   ...
   Protected Overrides Sub OnLoad(ByVal e As System.EventArgs)
      ...
      Try
         ...
         Me.cmbPreEntrega.Items.Insert(2, "LIBERADO")
...
#Region "Metodos"
   ...
   Private Sub CargarGrillaDetalle()
      ...
      _dtListasDetalle = New Reglas.ListasControlProductos().LiberarProducto(If(chbProducto.Checked, bscCodigoProducto2.Text, String.Empty),
