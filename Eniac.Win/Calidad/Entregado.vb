...
#Region "Overrides"
   ...
   Protected Overrides Sub OnLoad(ByVal e As System.EventArgs)
      ...
      Try
         ...
         Me.cmbPreEntrega.Items.Insert(2, "ENTREGADO")
...
#End Region
   ...
   Private Sub cmbPreEntrega_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cmbPreEntrega.SelectedIndexChanged
      Try
         ...
         If cmbPreEntrega.Text = "TODOS" Or cmbPreEntrega.Text = "ENTREGADO" Then
            Fechas = True
         End If
...
#Region "Metodos"
   ...
   Private Sub CargarGrillaDetalle()
      ...
      _dtListasDetalle = New Reglas.ListasControlProductos().EntregadoACLiente(If(chbProducto.Checked, bscCodigoProducto2.Text, String.Empty),
                                                                                     dtpDesde.Value, dtpHasta.Value,
                                                                                     If(chbCliente.Checked, bscCodigoCliente.Tag.ToString().ValorNumericoPorDefecto(0L), 0),
   ...
   Private Function CargarFiltrosImpresion() As String
      ...
      With filtro
         ...
         If Me.cmbPreEntrega.SelectedIndex >= 0 Then
            .AppendFormat(" Entregado: {0}", Me.cmbPreEntrega.Text.ToString())
         End If
