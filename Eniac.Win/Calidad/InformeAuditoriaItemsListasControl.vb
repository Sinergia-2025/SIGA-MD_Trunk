...
#End Region
Public Class InformeAuditoriaItemsListasControl
...
#Region "Metodos"
   ...
   Private Sub CargarGrillaDetalle()
      ...
      _dtItemsDetalle = New Reglas.ListasControlProductosItems().GetListasControlxProductoPendientesAuditoria(If(chbProducto.Checked, bscCodigoProducto2.Text, String.Empty),
...
#End Region
   ...
   Public Sub CargaAuditoriasListas()
      ...
      If drLista IsNot Nothing Then
         ...
         _dtItemsListasControlAuditoria = New Reglas.ListasControlProductosItems().GetListasControlxProducto_Auditoria(drLista.Field(Of String)(Entidades.ListaControlProducto.Columnas.IdProducto.ToString()))
         bdItemsListasControlAuditoria.DataSource = _dtItemsListasControlAuditoria
         ...
         Me.ugdItemsListasControlAuditoria.DataSource = New DataView(_dtItemsListasControlAuditoria,
                                                     ...
                                                     Entidades.ListaControlProducto.Columnas.IdProducto.ToString(), drLista(Entidades.ListaControlProducto.Columnas.IdProducto.ToString()), Entidades.ListaControlProductoItem.Columnas.IdListaControlItem.ToString(),
                                                     drLista(Entidades.ListaControlProductoItem.Columnas.IdListaControlItem.ToString())),
                                                                    "", DataViewRowState.CurrentRows)
