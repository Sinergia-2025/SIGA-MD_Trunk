...
#Region "Overrides"
   ...
   Protected Overrides Sub OnLoad(ByVal e As System.EventArgs)
      ...
      Try
         ...
         _publicos.CargaComboDesdeEnum(Me.cmbCorreoEnviado, GetType(TipoEnvio))
         Me.cmbCorreoEnviado.SelectedValue = TipoEnvio.M_Manual
...
#Region "Métodos"
   ...
   Private Sub CargarGrillaDetalle()
      ...
      If Me.cmbCorreoEnviado.Text <> "TODOS" Then
         TipoEnvio = Strings.Left(Me.cmbCorreoEnviado.Text, 1)
      End If

      Dim oEnviosOC As Reglas.EnviosOC = New Reglas.EnviosOC
      Dim dtDetalle As DataTable
      dtDetalle = oEnviosOC.GetInforme(IdPedido, TipoEnvio, FechaDesde,
