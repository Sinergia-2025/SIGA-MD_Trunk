...
#End Region
Public Class InformeListasControlPendientes
...
#End Region
   ...
   Private Sub chbItems_CheckedChanged(sender As Object, e As EventArgs) Handles chbItems.CheckedChanged
      Try
         Me.clbItems.Enabled = Me.chbItems.Checked
         If Not Me.chbItems.Checked Then
            Dim n As Integer
            For n = 0 To clbItems.Items.Count - 1
               clbItems.SetItemChecked(n, False)
            Next
         End If
      Catch ex As Exception
         ShowError(ex)
...
#Region "Metodos"
   ...
   Private Sub CargarGrillaDetalle()
      ...
      For n = 0 To clbItems.Items.Count - 1
         If clbItems.GetItemChecked(n) = True Then
            Items.Add(clbItems.Items(n).ToString())
            entro = True
         End If
      Next
      If Not entro Then
      ...
      _dtItemsDetalle = New Reglas.ListasControlProductosItems().GetListasControlxProductoPendientes(If(chbProducto.Checked, bscCodigoProducto2.Text, String.Empty),
                                                                                     dtpDesde.Value, dtpHasta.Value, ListaControl,
                                                                                      ...
                                                                                      IdEstado, Ubicacion, Items, TipoListaControl)
