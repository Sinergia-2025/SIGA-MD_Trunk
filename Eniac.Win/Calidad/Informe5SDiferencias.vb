...
#End Region
Public Class Informe5SDiferencias
...
#Region "Overrides"
   ...
   Protected Overrides Sub OnLoad(ByVal e As System.EventArgs)
      ...
      Try
         ...
         Me.cmb5S.Items.Insert(0, "TODOS")
         Me.cmb5S.Items.Insert(1, "DIFERENCIAS")
         Me.cmb5S.SelectedIndex = 0
...
#Region "Metodos"
   ...
   Private Sub CargarGrillaDetalle()
      ...
      _dtListasDetalle = New Reglas.ListasControlProductos().GetListasControlProductos(If(chbProducto.Checked, bscCodigoProducto2.Text, String.Empty),
                                                                                     dtpDesde.Value, dtpHasta.Value, Estado,
                                                                                      ...
                                                                                      ListaControl, 0, If(chbCliente.Checked, bscCodigoCliente.Tag.ToString().ValorNumericoPorDefecto(0L), 0L),
                                                                                      cmb5S.Text.ToString(), Ubicacion)
   ...
   Private Function CargarFiltrosImpresion() As String
      ...
      With filtro
         ...
         If Me.cmb5S.SelectedIndex >= 0 Then
            .AppendFormat(" 5S: {0} - ", Me.cmb5S.Text.ToString())
         End If
         ...
         If Me.cmbEstadoCalidad.SelectedIndex >= 0 Then
            .AppendFormat(" Entregado: {0} - ", Me.cmbEstadoCalidad.Text.ToString())
         End If
