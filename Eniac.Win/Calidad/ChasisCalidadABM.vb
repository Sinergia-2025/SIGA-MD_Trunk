...
#Region "Overrides"
   ...
   Protected Overrides Function GetDetalle(ByVal estado As StateForm) As Eniac.Win.BaseDetalle
      If estado = StateForm.Actualizar Then
         Return New ChasisCalidadDetalle(DirectCast(Me.GetEntidad(), Entidades.Producto))
      End If
      Return New ChasisCalidadDetalle(New Eniac.Entidades.Producto())
   End Function
   ...
   Protected Overrides Function GetAll(rg As Reglas.Base) As DataTable
      Return DirectCast(rg, Reglas.Productos).GetChasisCalidad()
   End Function
