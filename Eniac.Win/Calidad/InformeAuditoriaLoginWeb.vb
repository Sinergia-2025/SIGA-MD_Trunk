...
Public Class InformeAuditoriaLoginWeb
...
#Region "Overrides"
   ...
   Protected Overrides Sub OnLoad(ByVal e As System.EventArgs)
      ...
      Try
         ...
         Me._publicos.CargaComboUsuariosWebCalidad(Me.cmbUsuario)

         '-.PE-31628.-
         Ayudante.Grilla.AgregarFiltroEnLinea(ugDetalle, {"nombre_usuario", "navegador", "pais"})
...
#Region "Metodos"
   ...
   Private Sub CargaGrillaDetalle()
      ...
      Try
         ...
         Dim oAuditoriaLogin As Reglas.AuditoriaLoginWeb = New Reglas.AuditoriaLoginWeb()
         ...
         dtAuditoria = oAuditoriaLogin.GetAuditorias(dtpDesde.Value, dtpHasta.Value, IdUsuario)
         ...
         Me.ugDetalle.DataSource = dtAuditoria
