Option Strict On
Option Explicit On
Public Class ChasisCalidadDetalle
...
#Region "Overrides"
   ...
   Protected Overrides Sub OnLoad(ByVal e As System.EventArgs)
      ...
      Try
         ...
         _publicos.CargaComboTiposServiciosProducto(cmbTipoServicio)
         ...
         If StateForm = Win.StateForm.Insertar Then
            ...
            cmbTipoServicio.SelectedValue = 3

            Me.txtIdProducto.Text = New Reglas.Productos().GetProximoCodigo("CH")
         ...
         Else
            ...
            If DirectCast(Me._entidad, Entidades.Producto).CalidadNumeroChasis <> Nothing Then
               ...
               Me.txtNroMotor.Text = DirectCast(Me._entidad, Entidades.Producto).CalidadNroDeMotor
...
#End Region
   ...
   Private Sub txtNombreGrupoItem_TextChanged(sender As Object, e As EventArgs)
      Try
