...
#Region "Metodos"
   ...
   Private Sub CargarGrillaDetalle()
      ...
      Dim pivotResult As Reglas.ListasControlProductos.GetProductosPorListasControlPivotInfo

      pivotResult = New Reglas.ListasControlProductos().GetProductosPorListasControl(If(chbProducto.Checked, bscCodigoProducto2.Text, String.Empty),
                                                                                     dtpDesde.Value, dtpHasta.Value, Estado,
                                                                                     chbFechaLiberado.Checked, chbFechaEntregado.Checked,
                                                                                     If(chbCliente.Checked, bscCodigoCliente.Tag.ToString().ValorNumericoPorDefecto(0L), 0L), Ubicacion)
      ...
      With ugDetalle.DisplayLayout.Bands(0)
         For Each drColumnas As DataRow In pivotResult.dtColumnas.Rows
            pos += 1
            .Columns(drColumnas("NombreColumma").ToString()).FormatearColumna(drColumnas("NombreListaControl").ToString(), pos, 90, HAlign.Center)
         Next
      End With
