Public Class TableroDeComandox4
   Inherits BaseForm
...
#Region "Overrides"
   Protected Overrides Sub OnLoad(e As EventArgs)
      ...
      Try
         ...
         Dim tablero = _controller.Inicializar(_parametros, {ugGrilla1, ugGrilla2, ugGrilla3, ugGrilla4}, Panel1, New Point(lblSegundos.Left + lblSegundos.Width, 5))
