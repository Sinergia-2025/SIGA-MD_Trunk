...
Public Class InfVentasSumaPorRubros
...
#Region "Campos"
   ...
   Private Grilla As UltraGrid '-.PE-32537.-
...
#Region "Overrides"
   ...
   Protected Overrides Sub OnLoad(ByVal e As System.EventArgs)
      ...
      Try
         ...
         Ayudante.Grilla.AgregarFiltroEnLinea(ugDetalle, {"NombreRubro", "NombreListaPrecios", "DescripcionFormasPago"})


         '# Selecciono todos los tabs para que me tome las preferencias y las inicializo.
         Me.tbcAgrupados.SelectedTab = tbpXListaPrecios
         Me.tbcAgrupados.SelectedTab = tbpXZonaGeografica
         Me.tbcAgrupados.SelectedTab = tbpXRubros

         Me.CargarColumnasASumar()

         '# Grilla x Rubro
         Me.ugDetalleXRubro.AgregarFiltroEnLinea({"NombreRubro"})
         Ayudante.Grilla.AgregarTotalesSuma(Me.ugDetalleXRubro, {"Cantidad", "ImporteTotalNeto", "ImporteTotal", "Kilos"})
...
#Region "Eventos"
   ...
   Private Sub tsbImprimir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsbImprimir.Click
      ...
      Try
         ...
         If Me.tbcAgrupados.SelectedTab Is tbpXListaPrecios Then
            Me.UltraGridPrintDocument1.Grid = ugDetalle
         Else
            Me.UltraGridPrintDocument1.Grid = ugvXZona
         End If
   ...
   Private Sub tsmiAExcel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsmiAExcel.Click
      ...
      Try
         ...
         excelExport.Exportar(String.Format("{0}.xls", Me.Name), Text, Grilla, CargarFiltrosImpresion())
      Catch ex As Exception
         MessageBox.Show(ex.Message, Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Information)
      End Try
   End Sub
   ...
   Private Sub tsmiAPDF_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsmiAPDF.Click
      Try
         ...
         excelExport.Exportar(String.Format("{0}.pdf", Me.Name), Text, Grilla, CargarFiltrosImpresion())
      Catch ex As Exception
         MessageBox.Show(ex.Message, Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Information)
      End Try
   End Sub
   ...
   Private Sub tsbPreferencias_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsbPreferencias.Click
      Try
         'Dim pre As Preferencias
         If Me.tbcAgrupados.SelectedTab Is tbpXRubros Then
            Me.PreferenciasCargar(Me.ugDetalleXRubro, ugDetalleXRubro.Name, tsbPreferencias)
         ElseIf Me.tbcAgrupados.SelectedTab Is tbpXListaPrecios Then
            Me.PreferenciasCargar(Me.ugDetalle, ugDetalle.Name, tsbPreferencias)
         ElseIf Me.tbcAgrupados.SelectedTab Is tbpXZonaGeografica Then
            Me.PreferenciasCargar(Me.ugvXZona, ugvXZona.Name, tsbPreferencias)
         End If
      Catch ex As Exception
         ShowError(ex)
      End Try
   ...
   Private Sub chkExpandAll_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkExpandAll.CheckedChanged
      If Me.chkExpandAll.Checked Then
         ...
         Me.ugvXZona.Rows.ExpandAll(True)
      Else
...
#Region "Metodos"
   ...
   Private Sub RefrescarDatos()
      ...
      End If
      If Not Me.ugDetalleXRubro.DataSource Is Nothing Then
         DirectCast(Me.ugDetalleXRubro.DataSource, DataTable).Rows.Clear()
      End If
      If Not Me.ugvXZona.DataSource Is Nothing Then
         DirectCast(Me.ugvXZona.DataSource, DataTable).Rows.Clear()
      End If
   ...
   Private Sub CargaGrillaDetalle()
      ...
      Try
         ...
         Dim dtDetalleLista As DataTable
         Dim dtDetalleZona As DataTable
         Dim dtDetalleRubro As DataTable

         Dim dtLista As DataTable

         Dim drCl As DataRow

         dtDetalleRubro = oVenta.GetSumaPorRubros(Entidades.Venta.SumaXAgrupamiento.RUBRO, Me.cmbSucursal.GetSucursales(), _
         ...
         dtDetalleLista = oVenta.GetSumaPorRubros(Entidades.Venta.SumaXAgrupamiento.LISTA, Me.cmbSucursal.GetSucursales(), _
                                                Me.dtpDesde.Value, Me.dtpHasta.Value, _
                                                IdVendedor,
                                                IdCliente, _
                                                IdMarca, _
         ...
         dtDetalleZona = oVenta.GetSumaPorRubros(Entidades.Venta.SumaXAgrupamiento.ZONA, Me.cmbSucursal.GetSucursales(), _
                                              Me.dtpDesde.Value, Me.dtpHasta.Value, _
                                              IdVendedor,
                                              IdCliente, _
                                              IdMarca, _
         ...
         For Each dr As DataRow In dtDetalleLista.Rows
            ...
            dtLista.Rows.Add(drCl)

         Next

         Me.ugDetalleXRubro.DataSource = dtDetalleRubro
         Me.ugvXZona.DataSource = dtDetalleZona
         Me.ugDetalle.DataSource = dtLista
   ...
   Private Function CrearDTXLista() As DataTable
      ...
      With dtTemp
         ...
         .Columns.Add("IdSucursal", GetType(Int32))
      End With
...
#End Region
   ...
   Private Sub SeteaGrillaLista()

      Ayudante.Grilla.FormatearColumna(Me.ugDetalle.DisplayLayout.Bands(0).Columns("IdSucursal"), "S.", 0, 40, HAlign.Right, Me.chbUnificar.Checked, "", "", UltraWinGrid.Activation.ActivateOnly)

   End Sub

   Private Sub SeteaGrillaZona()
      Ayudante.Grilla.AgregarTotalesSuma(Me.ugvXZona, {"Cantidad", "ImporteTotalNeto", "ImporteTotal"})

      'Ayudante.Grilla.FormatearColumna(Me.ugvXZona.DisplayLayout.Bands(0).Columns("IdSucursal"), "S.", 0, 40, HAlign.Right, Me.chbUnificar.Checked, "", "", UltraWinGrid.Activation.ActivateOnly)
      'Ayudante.Grilla.FormatearColumna(Me.ugvXZona.DisplayLayout.Bands(0).Columns("NombreRubro"), "Nombre Rubro", 1, 150, HAlign.Left, False, "", "", UltraWinGrid.Activation.ActivateOnly)
      'Ayudante.Grilla.FormatearColumna(Me.ugvXZona.DisplayLayout.Bands(0).Columns("IdZonaGeografica"), "Zona", 2, 150, HAlign.Left, False, "", "", UltraWinGrid.Activation.ActivateOnly)
      'Ayudante.Grilla.FormatearColumna(Me.ugvXZona.DisplayLayout.Bands(0).Columns("Stock"), "Stock", 3, 100, HAlign.Right, False, "N2", "", UltraWinGrid.Activation.ActivateOnly)
      'Ayudante.Grilla.FormatearColumna(Me.ugvXZona.DisplayLayout.Bands(0).Columns("Cantidad"), "Cantidad", 4, 100, HAlign.Right, False, "N2", "", UltraWinGrid.Activation.ActivateOnly)
      'Ayudante.Grilla.FormatearColumna(Me.ugvXZona.DisplayLayout.Bands(0).Columns("ImporteTotalNeto"), "Total Neto", 5, 100, HAlign.Right, False, "N2", "", UltraWinGrid.Activation.ActivateOnly)
      'Ayudante.Grilla.FormatearColumna(Me.ugvXZona.DisplayLayout.Bands(0).Columns("ImporteTotal"), "Total", 6, 100, HAlign.Right, False, "N2", "", UltraWinGrid.Activation.ActivateOnly)
      'Ayudante.Grilla.FormatearColumna(Me.ugvXZona.DisplayLayout.Bands(0).Columns("Kilos"), "Kilos", 7, 80, HAlign.Right, False, "N2", "", UltraWinGrid.Activation.ActivateOnly)

      If Me.ugvXZona.DisplayLayout.Bands(0).SortedColumns.Count = 0 Then
         Me.ugvXZona.DisplayLayout.Bands(0).SortedColumns.Add("IdZonaGeografica", True, True)
      End If
      Me.ugvXZona.Rows.ExpandAll(True)
   End Sub

   Private Sub tbcAgrupados_SelectedIndexChanged(sender As Object, e As EventArgs) Handles tbcAgrupados.SelectedIndexChanged

      If tbcAgrupados.SelectedTab Is tbpXListaPrecios Then
         PreferenciasLeer(grid:=ugDetalle, sufijoXML:=ugDetalle.Name.ToString(), tsbPreferencias:=tsbPreferencias)
         Grilla = ugDetalle
      End If

      If tbcAgrupados.SelectedTab Is tbpXRubros Then
         PreferenciasLeer(grid:=ugDetalleXRubro, sufijoXML:=ugDetalleXRubro.Name.ToString(), tsbPreferencias:=tsbPreferencias)
         Grilla = ugDetalleXRubro
      End If

      If tbcAgrupados.SelectedTab Is tbpXZonaGeografica Then
         PreferenciasLeer(grid:=ugvXZona, sufijoXML:=ugvXZona.Name.ToString(), tsbPreferencias:=tsbPreferencias)
         Grilla = ugvXZona
      End If
