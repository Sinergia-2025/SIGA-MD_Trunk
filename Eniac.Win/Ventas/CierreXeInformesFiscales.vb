...
Public Class CierreXeInformesFiscales
...
#Region "Metodos"
   ...
   Private Sub HacerInformeFiscal()
...
#Region "Eventos"
   ...
   Private Sub btnProceder_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnProceder.Click
      ...
      Try
         ...
         If MessageBox.Show("Confirma la Emisión del Informe ? ", Me.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
            ...
            If oImpresora.Metodo.Value = Entidades.Impresora.MetodosFiscal.BATCH Then
               ...
               Me.HacerInformeFiscal()

            Else

               'Dim strRespuesta As String

               'strRespuesta = AbrirOCX()

               'If strRespuesta <> "OK" Then
               '   MsgBox(strRespuesta, MsgBoxStyle.Critical, Me.Text)
               '   Exit Sub
               'End If

               'HacerCierreZOCX()

               MessageBox.Show("ATENCION: No esta configurada la Impresora Fiscal como BATCH !!!" & Chr(13) & Chr(13) & "Por favor contáctese con SISTEMAS", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Information)


            End If

         Else
            MessageBox.Show("Usted ha cancelado el Informe !!!", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Information)
         End If
