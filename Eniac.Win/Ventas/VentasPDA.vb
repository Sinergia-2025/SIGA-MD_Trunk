...
Public Class VentasPDA

#Region "Propiedades"

   Private _lineas As List(Of VentasPDALinea)
   Public ReadOnly Property Lineas() As List(Of VentasPDALinea)
      Get
         If Me._lineas Is Nothing Then
            Me._lineas = New List(Of VentasPDALinea)()
         End If
         Return _lineas
      End Get
   End Property
...
#Region "Metodos Publicos"
   ...
   Public Sub GrabarArchivo(ByVal destino As String)
      ...
      Try
         ...
         For Each linea As VentasPDALinea In Lineas
