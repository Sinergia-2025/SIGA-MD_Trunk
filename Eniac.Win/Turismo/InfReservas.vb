...
#Region "Metodos"
   ...
   Private Sub CargaGrillaDetalle()
      ...
      Dim regla As Reglas.ReservasTurismo = New Reglas.ReservasTurismo()
      ...
      Dim dtDetalle As DataTable = regla.InfReservas(idCliente, fechaDesde, fechaHasta) 'ENVIAR PARAMETROS DE FILTRO ACA
