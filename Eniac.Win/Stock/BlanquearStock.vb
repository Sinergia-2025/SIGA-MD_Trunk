...
#Region "Eventos"
   ...
   Private Sub tsbBlanquear_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsbBlanquear.Click
      Me.ProcesarStock()
   End Sub
...
#Region "Metodos"
   ...
   Private Sub RefrescarDatosGrilla()
      ...
      Me.dgvDetalle.DataSource = oProd.GetPorNombreMarcaRubro(IdMarca, IdRubro, idSubRubro, "", actual.Sucursal.Id, "TODOS", ConStock)
   ...
   Private Sub ProcesarStock()
      ...
      Try
         ...
         If lngTotalReg = 1 Then
            strMensaje = "¿ Procede a BLANQUEAR el STOCK del Producto Seleccionado ?"
         Else
            strMensaje = "¿ Procede a BLANQUEAR el STOCK de los " & lngTotalReg.ToString & " Productos Seleccionados ?"
         End If
            ...
            If Not dr.Cells("chkBlanquear").Value Is Nothing Then
               ...
               If Boolean.Parse(dr.Cells("chkBlanquear").Value.ToString()) Then
                  ...
                  Try
                     ...
                     oProductos.BlanquearStock(actual.Sucursal.Id,
                                               Integer.Parse(dr.Cells("IdDeposito").Value.ToString),
                                               Integer.Parse(dr.Cells("IdUbicacion").Value.ToString),
                  ...
                  Catch ex As Exception
                     ...
                     strMensaje = "IMPOSIBLE BLANQUEAR el STOCK del Producto " & dr.Cells("Producto").Value.ToString & "-" & dr.Cells("NombreProducto").Value.ToString
         ...
         Select Case lngTotalRegProcesados
            Case 0
               strMensaje = " ATENCION!!: NO se BLANQUEO el STOCK de ningún Producto !!"
            Case 1
               strMensaje = " Producto con STOCK BLANQUEADO SATISFACTORIAMENTE !!"
            Case Else
               strMensaje = lngTotalRegProcesados.ToString & " productos de " & lngTotalReg.ToString & " (Seleccionados) fueron BLANQUEADOS SATISFACTORIAMENTE !!"
         End Select
