Public Class CmdExportacionRecibos
   Implements IComandoMenu
   Implements IConParametros

   Private Const Tag As String = "CmdExportacionRecibos.Ejecutar"
   ...
   Public Sub Ejecutar(owner As IWin32Window, idFuncion As String) Implements IComandoMenu.Ejecutar
      ...
      Using frm As ImpresionMasivaRecibos = New ImpresionMasivaRecibos(silentMode:=True)
         frm.Show()
         ...
         If Not frm.ugDetalle.Rows.Count > 0 Then
            My.Application.Log.WriteEntry(String.Format("{0} - No existen recibos para exportar", Tag), TraceEventType.Verbose)
         ...
         frm.cmbTodos.SelectedValue = Reglas.Publicos.TodosEnum.MararTodos
         frm.MarcarTodos()
   ...
   Public Function GetParametrosDisponibles() As String Implements IConParametros.GetParametrosDisponibles
      ...
      stb.AppendFormatLine("CantidadMesesAExportar - Cantidad de meses que se le resta a la fecha desde - 0")
      stb.AppendFormatLine("UbicacionDestino - Ubicación donde exportar los PDFs - Valor requerido")
      stb.AppendFormatLine("Exportado - Filtro de Exportado - Default False")
      Return stb.ToString()
   End Function
