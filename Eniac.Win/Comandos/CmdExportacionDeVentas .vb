Public Class CmdExportacionDeVentas
   Implements Eniac.Win.IComandoMenu
   Implements IConParametros

   Private Const Tag As String = "CmdExportacionVentasCoca.Ejecutar"

   Private _raiz As String
   Private _Formato As String = String.Empty
   Private _TiposComprobantesVenta As String = String.Empty
   ...
   Public Sub Ejecutar(owner As IWin32Window, idFuncion As String) Implements IComandoMenu.Ejecutar
      ...
      Using frm As ExportacionDeVentas = New ExportacionDeVentas()
         frm.Show()
   ...
   Private Sub SetParametrosDeExportacion(parametros As String)
      ...
      For Each p As String In parametros.Split(";"c)
         ...
         Select Case keyValue(0)
            Case ParametrosPermitidos.Formato.ToString()
               _Formato = If(keyValue.Length > 0, keyValue(1).ToString(), String.Empty)
            Case ParametrosPermitidos.TipoComprobanteVenta.ToString()
               _TiposComprobantesVenta = If(keyValue.Length > 0, keyValue(1).ToString(), String.Empty)
