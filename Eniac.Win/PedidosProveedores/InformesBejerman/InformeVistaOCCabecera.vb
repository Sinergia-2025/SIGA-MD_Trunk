...
Public Class InformeVistaOCCabecera
...
#Region "Métodos"
   ...
   Private Function CargarFiltrosImpresion() As String
      ...
      With filtro
         .AppendFormatLine("Fecha Ingreso: Desde {0} Hasta {1} - ", Me.dtpIngresoDesde.Text, Me.dtpIngresoHasta.Text)
   ...
   Private Sub SetearFechas()
      Me.dtpIngresoDesde.Value = UltimoSegundoDelDia(Date.Today.AddDays(-1)).AddSeconds(1)
      Me.dtpIngresoHasta.Value = UltimoSegundoDelDia(Me.dtpIngresoDesde.Value)
   ...
   Private Sub CargarGrillaDetalle()
      ...
      Dim fechaIngresoDesde As Date = Me.dtpIngresoDesde.Value
      Dim fechaIngresoHasta As Date = Me.dtpIngresoHasta.Value
      ...
      Me.ugDetalle.DataSource = rSincronizarOC.GetCabecerasBejerman(fechaModificacionDesde, fechaModificacionHasta,
                                                                    fechaIngresoDesde, fechaIngresoHasta)

      Me.ugDetalle.DisplayLayout.Bands(0).Columns("scc_FecMod").Format = "dd/MM/yyyy HH:mm"
      '# Preferencias
