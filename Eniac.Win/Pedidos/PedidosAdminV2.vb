...
#Region "Eventos"
   ...
   Private Sub tsbImprimirPredisenado_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsbImprimirPredisenado.Click
      Try
         Me.Cursor = Cursors.WaitCursor
   ...
   Private Sub chbFecha_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chbFecha.CheckedChanged, btnDetallePorProductos.CheckedChanged
   ...
   Private Sub ugDetalle_AfterCellActivate(ByVal sender As Object, ByVal e As System.EventArgs) Handles ugDetalle.AfterCellActivate
   ...
   ''''Private Sub cmdMasivo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
   ''''   Try
   ...
   'Private Sub cmbEstadoCambiar_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
   '   If e.KeyCode = Keys.Enter Then
   '      Me.ProcessTabKey(True)
   '   End If
   'End Sub

   'Private Sub cmbResponsable_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
   '   If e.KeyCode = Keys.Enter Then
   '      Me.ProcessTabKey(True)
   '   End If
   'End Sub

   'Private Sub txtCantidad_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
   '   If e.KeyCode = Keys.Enter Then
   '      Me.ProcessTabKey(True)
   '   End If
   'End Sub
   ...
   'Private Sub txtCantidad_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs)
...
#End Region
   ...
   'Private Sub cmbCriticidad_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
   '   If e.KeyCode = Keys.Enter Then
   '      Me.ProcessTabKey(True)
   '   End If
   'End Sub
   ...
   'Private Sub dtpFechaEntrega_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
   '   If e.KeyCode = Keys.Enter Then
   '      Me.ProcessTabKey(True)
   '   End If
   'End Sub
   ...
   Private Sub ugdDetalle_ClickCellButton(ByVal sender As System.Object, ByVal e As Infragistics.Win.UltraWinGrid.CellEventArgs) Handles ugDetalle.ClickCellButton
      Try
   ...
   'Private Sub chbCriticidad_CheckedChanged(sender As Object, e As EventArgs)
   '   Try
   '      If Me.chbCriticidad.Checked Then
   ...
   'Private Sub chbFechaEntrega_CheckedChanged(sender As Object, e As EventArgs)
   '   Try
   '      If Me.chbFechaEntrega.Checked Then
   ...
   Private Sub ToolStripButton1_Click(sender As Object, e As EventArgs) Handles ToolStripButton1.Click
      ...
      Sub()
         ugDetalle.UpdateData()
         Using frm = New PedidosAdminV2Confirmacion()
            Dim dt = ugDetalle.DataSource(Of DataTable).Where(Function(dr) dr.Field(Of String)("Masivo") = Boolean.TrueString).CopyToDataTable()
            If frm.ShowDialog(Me, dt) = DialogResult.OK Then
