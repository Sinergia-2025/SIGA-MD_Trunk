...
Public Class InformeDescuentosMarcas
...
#Region "Eventos"
   ...
   Private Sub InformeDescuentosMarcas_KeyUp(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyUp
   ...
   Private Sub btnConsultar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnConsultar.Click
      Try
         ...
         If Me.ugDetalle.Rows.Count > 0 Then
            Me.lnkFiltroMultiplesMarcas.Focus()
         Else
            Me.Cursor = Cursors.Default
   ...
   Private Sub tsbImprimir_Click(sender As System.Object, e As System.EventArgs) Handles tsbImprimir.Click
      Try
         ...
         If Me.lnkFiltroMultiplesMarcas.Text <> "Todas las Marcas" Then
            If Filtros.Length > 0 Then Filtros = Filtros & " / "
            Filtros = Filtros & "Marca: " & Me.lnkFiltroMultiplesMarcas.Text
         End If
...
#Region "Metodos"
   ...
   Private Sub CargaGrillaDetalle()
      ...
      Try
         ...
         Me.ugDetalle.DataSource = reg.GetInfClientesDescuentosMarcas(IdCliente, Me._filtroMultiplesMarcas.Filtros)
