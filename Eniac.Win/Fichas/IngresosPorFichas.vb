...
Public Class IngresosPorFichas
...
#Region "Eventos"
   ...
   Private Sub btnVer_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnVer.Click
      Try
         ...
         Dim dt As DataTable = oFPagos.GetIngresosPorFichas(Eniac.Entidades.Usuario.Actual.Sucursal.Id, Me.dtpDesde.Value, Me.dtpHasta.Value, IdCob)
         ...
         Dim frmImprime As VisorReportes = New VisorReportes("Eniac.Win.IngresosPorFichas.rdlc", "SistemaDataSet_IngresosPorFichas", dt, parm, 1) '# 1 = Cantidad Copias
         frmImprime.Text = "Ingresos por Fichas"
         frmImprime.Show()
