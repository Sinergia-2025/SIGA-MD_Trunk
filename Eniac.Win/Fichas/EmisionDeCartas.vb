...
#Region "Eventos"
   ...
   Private Sub btnEmitirCarta_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEmitirCarta.Click
      ...
      Dim reporteDataSource As String = "SistemaDataSet_PagosPendientes"
            ...
            If dr.Cells("Check").Value = True Then
               ...
               If Not primero Then
                  If ultimoIdCliente <> dr.Cells("IdCliente").Value Then
                     ...
                     Me.CargaParametrosEImprime("Eniac.Fichas.Win" & nombreReporte, reporteDataSource, dt, suma, ultimoIdCliente, ultimoNombre, strOperaciones)
