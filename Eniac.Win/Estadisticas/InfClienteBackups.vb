...
#End Region
Public Class InfClienteBackups
...
#Region "Metodos"
   ...
   Private Sub CargaGrillaDetalle()
      ...
      Dim regla As Reglas.ClientesBackups = New Reglas.ClientesBackups()
      ...
      Dim dtDetalle As DataTable = regla.InfClientesBackups(idCliente, fechaDesde, fechaHasta) 'ENVIAR PARAMETROS DE FILTRO ACA
