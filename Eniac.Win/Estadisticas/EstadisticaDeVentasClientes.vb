...
Public Class EstadisticaDeVentasClientes
...
#Region "Overrides"
   ...
   Protected Overrides Sub OnLoad(ByVal e As System.EventArgs)
      ...
      Try
         ...
         Ayudante.Grilla.AgregarFiltroEnLinea(ugDetalle, {"NombreProducto", "IdProducto"})
...
#Region "Eventos"
   ...
   Private Sub EstadisticaDeVentasClientes_KeyUp(sender As Object, e As KeyEventArgs) Handles MyBase.KeyUp
   ...
   Private Sub tsbImprimir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsbImprimir.Click
      ...
      Try
         ...
         Filtro1 += "Los " + Me.txtCantidad.Text + " mejores Clientes "
         ...
         If Me.chbVendedor.Checked Then
            If Filtro2.Length > 0 Then Filtro2 += " / "
            Filtro2 += "Vendedor: " & Me.cmbVendedor.Text
         End If
         ...
         Dim frmImprime As VisorReportes = New VisorReportes("Eniac.Win.EstadisticaDeVentasClientes.rdlc", "SistemaDataSet_EVentasClientes", dt, parm, True, 1) '# 1 = Cantidad Copias
...
#Region "Métodos"
   ...
   Public Sub CargaGrillaDetalle(ByVal suc As List(Of Integer))
      ...
      Try
         ...
         Dim dt As DataTable = reg.GetEstadVentasClientes(suc, cantidad, Me.dtpDesde.Value, Me.dtpHasta.Value, idMarca, idModelo, idRubro, idSubRubro, idproducto, IvaDiscriminado, IdVendedor)
