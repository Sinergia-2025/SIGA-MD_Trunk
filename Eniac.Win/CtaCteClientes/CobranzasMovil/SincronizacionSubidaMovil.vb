Public Class SincronizacionSubidaMovil
   ...
   Public Sub New()
      ...
      Try
         ...
         _publicos.CargaComboDesdeEnum(cmbSimovilCobranzaSucursales, GetType(Entidades.JSonEntidades.CobranzasMovil.SucursalesSincronizar))
         ...
         If Reglas.Publicos.Simovil.Subida.IncluirProductos Then
            chbPrecioConIVA.Checked = Reglas.Publicos.Simovil.PreciosConIVA
            chbSoloProductosConStock.Checked = Reglas.Publicos.Simovil.SoloProductosConStock
         End If
   ...
   Private Sub tsbExportar_Click(sender As Object, e As EventArgs) Handles tsbExportar.Click
      Try
         ...
         sincronizacion.SubirInformacion(nombreCliente, tipoDireccion, incluirClientes,
                                            chbPrecioConIVA.Checked, chbSoloProductosConStock.Checked, cmbSimovilCobranzaSucursales.ValorSeleccionado(Of Entidades.JSonEntidades.CobranzasMovil.SucursalesSincronizar))
   ...
   Public Sub sincronizacion_Estado(sender As Object, e As Reglas.ServiciosRest.CobranzasMovil.SincronizacionSubidaMovil.SincronizacionSubidaMovilEstadoEventArgs) Handles sincronizacion.Estado
      MostrarEstado(e)
   End Sub
   ...
   Private estados As Dictionary(Of Reglas.ServiciosRest.CobranzasMovil.SincronizacionSubidaMovil.Metodo, SincronizacionSubidaMovilEstadoTablaUserControl)
   Private Sub ResetearEstados()
      If estados IsNot Nothing Then
         For Each keyvalue As KeyValuePair(Of Reglas.ServiciosRest.CobranzasMovil.SincronizacionSubidaMovil.Metodo, SincronizacionSubidaMovilEstadoTablaUserControl) In estados
      ...
      End If
   End Sub
   Private Sub MostrarEstado(estado As Reglas.ServiciosRest.CobranzasMovil.SincronizacionSubidaMovil.SincronizacionSubidaMovilEstadoEventArgs)
      If estados Is Nothing Then estados = New Dictionary(Of Reglas.ServiciosRest.CobranzasMovil.SincronizacionSubidaMovil.Metodo, SincronizacionSubidaMovilEstadoTablaUserControl)()
