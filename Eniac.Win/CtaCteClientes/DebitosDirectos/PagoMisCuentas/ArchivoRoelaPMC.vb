...
#Region "Propiedades"
   ...
   Private _datos As List(Of ArchivoRoelaPMCDatos)
   Public Property Datos() As List(Of ArchivoRoelaPMCDatos)
      Get
         If Me._datos Is Nothing Then
            Me._datos = New List(Of ArchivoRoelaPMCDatos)()
         End If
         Return _datos
      End Get
      Set(ByVal value As List(Of ArchivoRoelaPMCDatos))
         _datos = value
      End Set
   End Property
   ...
   Public ReadOnly Property TotalImporte As Decimal
      Get
         ...
         For Each ar As ArchivoRoelaPMCDatos In Datos
...
#Region "Metodos Publicos"
   ...
   Public Sub GrabarArchivo(ByVal destino As String)
      ...
      Try
         ...
         For Each linea As ArchivoRoelaPMCDatos In Datos
         ...
         'Sumatoria del campo ‘Importe 1er.Vto.’ de los registros de detalle. 
         'Formato: 9 enteros, 2 decimales, sin separadores.
         stb.Append(Me.TotalImporte.ToString("000000000.00").Replace(",", "").Replace(".", ""))
         'Campo para uso futuro. Valor fijo: ceros.
         stb.Append(New String("0"c, 239))
...
Public Class ArchivoRoelaPMCDatos
...
#Region "Propiedades"
   ...
   Public Property NroRefinanciacion As Integer
...
#Region "Metodos Publicos"
   ...
   Public Function GetLinea() As String
      With Me._stb
         ...
         .Append("0" & Me.NroReferencia.ToString("00000000") & Eniac.Reglas.Publicos.TurismoRoelaIdentificadorCuenta.ToString("0000000000"))
         'Identificación de la factura. 
         'Se refiere a la identificación particular de la factura que está pagando el cliente. 
         ...
         .Append(Me.IdFactura.PadRight(15))
         'Código de moneda de los importes informados.Valor fijo: 0 (Pesos).Siempre es  0 e indica que la factura es en pesos.
         '-- REQ-35043.- Se solicita sea Fijo 1.- ------------------
         .Append(Me.NroRefinanciacion.ToString("0"))
         '----------------------------------------------------------
         'Periodo Tomado del Formulario.- 
         .Append(Me.FechaPeriodo.ToString("MMyy"))
         '-- REQ-35043.- Se solicita sea Fijo 0.- ------------------
         .Append("0")
         '----------------------------------------------------------
         ...
         .Append(Me.NroReferencia.ToString("000000000") & Eniac.Reglas.Publicos.TurismoRoelaIdentificadorCuenta.ToString("000000000"))
