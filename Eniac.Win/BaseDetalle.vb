      ...
      For Each cr As Control In Me.Controls
         If TypeOf cr Is System.Windows.Forms.GroupBox Then
            For Each cr1 As Control In cr.Controls
               ...
               End If
            Next
         ElseIf TypeOf cr Is System.Windows.Forms.Panel Then
            For Each cr1 As Control In cr.Controls
               If TypeOf cr1 Is System.Windows.Forms.Panel Then
                  For Each cr2 As Control In cr1.Controls
                     resultado += conf.ValidarControl(cr2)
                  Next
               Else
   ...
   Public Sub BindearControles(ByVal dataSource As Eniac.Entidades.Entidad, ByVal dataSources As Generic.Dictionary(Of String, Eniac.Entidades.Entidad))
      ...
      For Each ctr As Control In Me.Controls
         ...
         ElseIf TypeOf ctr Is Panel Then
            For Each ctr1 As Control In ctr.Controls
               If TypeOf ctr1 Is Panel Then
                  For Each ctr2 As Control In ctr1.Controls
                     Me.BindeaControl(ctr2, dataSource, dataSources)
                  Next
               ElseIf TypeOf ctr1 Is GroupBox Then
                  For Each ctr2 As Control In ctr1.Controls
                     ...
                     If TypeOf ctr1 Is GroupBox Then
                        For Each ctr2 As Control In ctr1.Controls
                           If TypeOf ctr2 Is GroupBox Then
                              ...
                              Next
                           ElseIf TypeOf ctr2 Is TableLayoutPanel Then
                              For Each ctr3 As Control In ctr2.Controls
                                 If TypeOf ctr3 Is Panel Then
                                    For Each ctr4 As Control In ctr3.Controls
                                       BindeaControl(ctr4, dataSource, dataSources)
                                    Next
                                 Else
                                    BindeaControl(ctr3, dataSource, dataSources)
                                 End If
                              Next
                           Else
                              Me.BindeaControl(ctr2, dataSource, dataSources)
...
#Region "Overridable"
   ...
   End Function
   Protected Overridable Function GetReglas(Of T As Reglas.Base)() As T
      Dim r = GetReglas()
      If TypeOf (r) Is T Then
      ...
      For Each ctr As Control In Me.Controls
         If TypeOf ctr Is System.Windows.Forms.GroupBox Then
            For Each ctr1 As Control In ctr.Controls
               ...
               End If
            Next
         ElseIf TypeOf ctr Is System.Windows.Forms.Panel Then
            For Each ctr1 As Control In ctr.Controls
               If TypeOf ctr1 Is System.Windows.Forms.Panel Then
                  For Each ctr2 As Control In ctr1.Controls
                     LimpiarControl(ctr2)
                  Next
               Else
