...
#Region "Propiedades"
    ...
    Public Property IngresoFechaDesde() As Date?
    Public Property IngresoFechaHasta() As Date?
...
#Region "Overrides"
    ...
    Protected Overrides Sub OnLoad(ByVal e As System.EventArgs)
        ...
        Try
            ...
            If Me.IngresoFechaDesde.HasValue Then
                Me.FIngresoDesde.Value = Me.IngresoFechaDesde.Value
            Else
                Me.FIngresoDesde.Value = DateTime.Today
            End If

            If Me.IngresoFechaHasta.HasValue Then
                Me.FIngresoHasta.Value = Me.IngresoFechaHasta.Value
            Else
                Me.FIngresoHasta.Value = DateTime.Today.Date.AddHours(23).AddMinutes(59).AddSeconds(59)
            End If
...
#Region "Metodos"
    ...
    Private Sub CargaGrillaDetalle()
        ...
        dtDetalle = oc.GetInfVistaCabecera("SBVACIA.dbo.", dtpDesde.Value, dtpHasta.Value, FIngresoDesde.Value, FIngresoHasta.Value)
