...
#Region "Propiedades"
   ...
   Private _lineas As List(Of CitiVentasLinea)
   Public ReadOnly Property Lineas() As List(Of CitiVentasLinea)
      Get
         If Me._lineas Is Nothing Then
            Me._lineas = New List(Of CitiVentasLinea)()
         End If
         Return _lineas
      End Get
   End Property
   ...
   Public ReadOnly Property CantidadDeLineasaProcesar() As Integer
      Get
         ...
         For Each li As CitiVentasLinea In Me.Lineas
            If li.Procesar Then
               cant += 1
            End If
         Next
...
#Region "Metodos Publicos"
   ...
   Public Sub GrabarArchivo(ByVal destino As String)
      ...
      Try
         ...
         For Each linea As CitiVentasLinea In Lineas
...
#Region "Metodos Publicos"
   ...
   Public Function GetLinea() As String
      With Me._stb
         ...
         If Me.FechaDeVencimiento = Nothing Then
...
#Region "Propiedades"
   ...
   Private _nroDeComprobanteHasta As Decimal
   Public Property NroDeComprobanteHasta() As Decimal
      Private Get
         Return _nroDeComprobanteHasta
      End Get
      Set(ByVal value As Decimal)
         _nroDeComprobanteHasta = value
      End Set
   End Property
