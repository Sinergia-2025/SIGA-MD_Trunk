...
Public Class CitiComprasAlicuotas

#Region "Propiedades"

   Private _lineas As List(Of CitiComprasAlicuotasLinea)
   Public ReadOnly Property Lineas() As List(Of CitiComprasAlicuotasLinea)
      Get
         If Me._lineas Is Nothing Then
            Me._lineas = New List(Of CitiComprasAlicuotasLinea)()
         End If
         Return _lineas
      End Get
   End Property
   ...
   Public ReadOnly Property CantidadDeLineasaProcesar() As Integer
      Get
         ...
         For Each li As CitiComprasAlicuotasLinea In Me.Lineas
            If li.Procesar Then
               cant += 1
            End If
         Next
...
#Region "Metodos Publicos"
   ...
   Public Sub GrabarArchivo(ByVal destino As String)
      ...
      Try
         ...
         For Each linea As CitiComprasAlicuotasLinea In Lineas
...
Public Class CitiComprasAlicuotasLinea
...
#Region "Metodos Publicos"
   ...
   Public Function GetLinea() As String
      With Me._stb
         ...
         If Me.ImporteNetoGravado < 0 Then
            .AppendFormat(Me.ImporteNetoGravado.ToString(New String("0"c, 14)))
         Else
         ...
         If Me.ImpuestoLiquidado < 0 Then
            .AppendFormat(Me.ImpuestoLiquidado.ToString(New String("0"c, 14)))
         Else
...
#Region "Propiedades"
   ...
   ''' </summary>
   ''' <remarks></remarks>
   Private _codigoDeDocumentoIdentificatorioDelVendedor As Integer = 80
   Public Property CodigoDeDocumentoIdentificatorioDelVendedor() As Integer
      Private Get
         Return _codigoDeDocumentoIdentificatorioDelVendedor
      End Get
      Set(ByVal value As Integer)
         _codigoDeDocumentoIdentificatorioDelVendedor = value
      End Set
   End Property

   Private _nroDeIdentificacionDelVendedor As Long
   Public Property NroDeIdentificacionDelVendedor() As Long
      Private Get
         Return _nroDeIdentificacionDelVendedor
      End Get
      Set(ByVal value As Long)
         _nroDeIdentificacionDelVendedor = value
      End Set
   End Property
   ...
   Public Property ImporteNetoGravado() As Decimal
      Private Get
         ...
         Return _importeNetoGravado * 100
      End Get
      Set(ByVal value As Decimal)
