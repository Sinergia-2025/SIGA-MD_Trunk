Public Class ConcesionarioSubTiposUnidadesDetalle
...
#Region "Constructores"
   Public Sub New(idUnidad As Integer)
      ' This call is required by the Windows Form Designer.
      InitializeComponent()
   End Sub
   Public Sub New(idTipoUnidad As Integer, subTipoUnidad As Entidades.ConcesionarioSubTipoUnidad)
      Me.InitializeComponent()
      Me._entidad = subTipoUnidad
...
#Region "Overrides"
   Protected Overrides Sub OnLoad(ByVal e As EventArgs)
      ...
      If Me.StateForm = Eniac.Win.StateForm.Actualizar Then
         ...
         radBtnSolCantPisos.Checked = DirectCast(_entidad, Entidades.ConcesionarioSubTipoUnidad).SolicitaCantPisos
         radBtnSolCantPuertasLat.Checked = DirectCast(_entidad, Entidades.ConcesionarioSubTipoUnidad).SolicitaCantPuertasLaterales
         radBtnSolVolumen.Checked = DirectCast(_entidad, Entidades.ConcesionarioSubTipoUnidad).SolicitaVolumen
      Else
   ...
   Protected Overrides Sub Aceptar()
      ...
      DirectCast(_entidad, Entidades.ConcesionarioSubTipoUnidad).SolicitaCantPisos = radBtnSolCantPisos.Checked
      DirectCast(_entidad, Entidades.ConcesionarioSubTipoUnidad).SolicitaCantPuertasLaterales = radBtnSolCantPuertasLat.Checked
      DirectCast(_entidad, Entidades.ConcesionarioSubTipoUnidad).SolicitaVolumen = radBtnSolVolumen.Checked
...
#Region "Metodos"
   Private Sub CargarUnidad(ByVal dr As DataGridViewRow)
      DirectCast(Me._entidad, Entidades.ConcesionarioSubTipoUnidad).IdTipoUnidad = Integer.Parse(dr.Cells("IdTipoUnidad").Value.ToString())
   ...
   Private Sub CargarProximoNumero()
      Dim rUnidad As Reglas.ConcesionarioSubTiposUnidades = New Reglas.ConcesionarioSubTiposUnidades()
      Me.txtIdSubUnidad.Text = (rUnidad.GetCodigoMaximo(Integer.Parse(Me.bscCodigoUnidad.Text)) + 1).ToString()
   End Sub
#End Region
End Class