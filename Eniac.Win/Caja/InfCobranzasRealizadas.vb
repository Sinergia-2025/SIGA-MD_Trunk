Public Class InfCobranzasRealizadas
   ...
   Protected Overrides Sub OnLoad(e As EventArgs)
      ...
      TryCatched(
         Sub()
            ...
            cmbTiposComprobantesAplicador.Initializar(False, "VENTAS")
            ...
            ugDetalle.AgregarTotalesSuma({"ImporteNeto", "ImporteTotal"})
...
#Region "Metodos"
   ...
   Private Sub CargaGrillasDetalle()
      ...
      Dim dtDetalleCC = rCaja.GetCobranzasDetalladas(cmbSucursal.GetSucursales(),
