...
DECLARE @IdTipoComprobanteOrigen as varchar(10) = 'NCRED-CYO';
DECLARE @CentroEmisorOrigen as int = 2;
DECLARE @LetraOrigen as varchar(1) = 'A';

DECLARE @IdTipoComprobanteDestino as varchar(10) = 'NCRED-CYO';	--No cambia
...
DECLARE @NumeroOrigen as int = 39;
DECLARE @NumeroDiferencia as int = 1-39;
