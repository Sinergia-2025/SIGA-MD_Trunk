...
BEGIN
    ...
    --          'Logistica', 10, 'Eniac.Win', 'FacturacionPedido', NULL);
    ...
    --          'Logistica', 30, 'Eniac.SiLIVE.Win', 'Preventa', NULL);
    ...
    --          'Logistica', 40, 'Eniac.SiLIVE.Win', 'OrganizarEntregas', NULL);
    ...
    --          'Logistica', 40, 'Eniac.SiLIVE.Win', 'Interfase', NULL);
    ...
    --          'Logistica', 45, 'Eniac.SiLIVE.Win', 'RegistracionPagos', NULL);
    ...
    --          'Logistica', 60, 'Eniac.SiLIVE.Win', 'RutasABM', NULL);
    ...
    --          'Logistica', 70, 'Eniac.SiLIVE.Win', 'RutasClientes', NULL);
    ...
    --          'Logistica', 80, 'Eniac.SiLIVE.Win', 'CargarOfertas', NULL);
    ...
    --          'Logistica', 100, 'Eniac.SiLIVE.Win', 'ConsultarRepartos', NULL);
    ...
    --          'Logistica', 200, 'Eniac.SiLIVE.Win', 'InfCajonesHectolitros', NULL);
    ...
    --          'Logistica', 210, 'Eniac.SiLIVE.Win', 'InfCanalesYRubros', NULL);
