...
#Region "Constructores"
   ...
   Public Sub New()
      Me.NombreEntidad = Entidades.CRMNovedadProductoLote.NombreTabla
...
#Region "Overrides"
   Public Sub _Inserta(entidad As Entidades.CRMNovedadProductoLote)
      '  Me.EjecutaSP(entidad, TipoSP._I)
   End Sub
   Public Sub _Actualiza(entidad As Entidades.CRMNovedadProductoLote)
      '  Me.EjecutaSP(entidad, TipoSP._U)
   End Sub
   Public Sub _Borra(entidad As Entidades.CRMNovedadProductoLote)
...
#Region "Métodos Públicos"
   ...
   Public Function GetTodos(idTipoNovedad As String, letra As String, centroEmisor As Short,
                            idNovedad As Long, idproducto As String) As List(Of Entidades.CRMNovedadProductoLote)
      Dim dt As DataTable = Me.GetAll(idTipoNovedad, letra, centroEmisor, idNovedad, idproducto)

      Return CargaLista(dt, Sub(o, dr) CargarUno(DirectCast(o, Entidades.CRMNovedadProductoLote), dr), Function() New Entidades.CRMNovedadProductoLote())
   End Function

   Public Overloads Function GetAll(idTipoNovedad As String, letra As String,
                                    centroEmisor As Short, idNovedad As Long,
                                    idproducto As String) As System.Data.DataTable
      Return New SqlServer.CRMNovedadesProductosLotes(Me.da).CRMNovedadesProductosLotes_GA(idTipoNovedad, letra, centroEmisor, idNovedad, idproducto)
   End Function

   Private Sub CargarUno(o As Entidades.CRMNovedadProductoLote, dr As DataRow)
      With o
         ...
         .LetraNovedad = dr.Field(Of String)(Entidades.CRMNovedadProductoLote.Columnas.LetraNovedad.ToString())
         .CentroEmisor = dr.Field(Of Short)(Entidades.CRMNovedadProductoLote.Columnas.CentroEmisor.ToString())
         .IdProducto = dr.Field(Of String)(Entidades.CRMNovedadProductoLote.Columnas.IdProducto.ToString())
         .OrdenProducto = dr.Field(Of Integer)(Entidades.CRMNovedadProductoLote.Columnas.OrdenProducto.ToString())
         .IdLote = dr.Field(Of String)(Entidades.CRMNovedadProductoLote.Columnas.IdLote.ToString())
         .FechaIngreso = dr.Field(Of Date)(Entidades.CRMNovedadProductoLote.Columnas.FechaIngreso.ToString())
         .FechaVencimiento = dr.Field(Of Date)(Entidades.CRMNovedadProductoLote.Columnas.FechaVencimiento.ToString())
         .CantidadActual = dr.Field(Of Decimal)(Entidades.CRMNovedadProductoLote.Columnas.CantidadActual.ToString())
         .IdSucursal = dr.Field(Of Integer)(Entidades.CRMNovedadProductoLote.Columnas.IdSucursal.ToString())
         .IdDeposito = dr.Field(Of Integer)(Entidades.CRMNovedadProductoLote.Columnas.IdDeposito.ToString())
         .IdUbicacion = dr.Field(Of Integer)(Entidades.CRMNovedadProductoLote.Columnas.IdUbicacion.ToString())
      End With
   End Sub
