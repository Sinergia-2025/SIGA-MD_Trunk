...
#Region "Constructores"
   ...
   Public Sub New()
      Me.NombreEntidad = "SueldosPersonalFamiliar"
...
#Region "Metodos Publicos"
   ...
   Public Function GetSueldosPersonalFamiliares(ByVal idLegajo As String) As DataTable

      Dim stbQuery As StringBuilder = New StringBuilder("")

      With stbQuery
         .AppendLine("   select f.idLegajo, f.CuilFamiliar, f.NombreFamiliar, f.FechaNacimientoFamiliar, f.SexoFamiliar, f.IdTipoVinculoFamiliar, t.NombreVinculoFamiliar")
         .AppendLine("   from SueldosPersonalFamiliares f ")
         .AppendLine("   inner join SueldosTiposVinculoFamiliar t on t.IdTipoVinculoFamiliar = f.IdTipoVinculoFamiliar")
