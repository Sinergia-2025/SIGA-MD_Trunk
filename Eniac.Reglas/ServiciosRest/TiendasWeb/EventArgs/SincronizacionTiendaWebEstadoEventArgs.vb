Namespace ServiciosRest.TiendasWeb
   Public Class SincronizacionTiendaWebEstadoEventArgs
      Inherits EventArgs
      Public Sub New(tienda As Entidades.TiendasWeb, estado As SincroTiendaWebEstados, metodo As SincroTiendaWebMetodos, totalRegistros As Long, totalRegistrosSubidos As Long)
         Me.New(tienda, estado, metodo, totalRegistros, totalRegistrosSubidos, nombre:=String.Empty, 0, 0)
      End Sub
      Public Sub New(tienda As Entidades.TiendasWeb, estado As SincroTiendaWebEstados, metodo As SincroTiendaWebMetodos, totalRegistros As Long, totalRegistrosSubidos As Long, nombre As String,
      ...
      Public Property Estado As SincroTiendaWebEstados
      Public Property Metodo As SincroTiendaWebMetodos
   ...
   End Class
   Public Enum SincroTiendaWebEstados
      Iniciando
      Importando
      Subiendo
      Bajando
