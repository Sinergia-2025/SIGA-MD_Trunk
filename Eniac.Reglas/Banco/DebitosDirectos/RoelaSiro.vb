...
#Region "Públicos"
      Public Shared Function ArmarCodigoBarras(
         ...
         Return ArmarCodigoBarras(identificacionDeUsuario,
                                  ...
                                  importeVenc2,
                                  If(fechaVenc2.HasValue AndAlso fechaVenc3.HasValue, Convert.ToInt32(fechaVenc3.Value.Subtract(fechaVenc2.Value).TotalDays), 0),
                                  importeVenc3,
                                  identificadorCuenta)
      End Function
      ...
      Public Shared Function ArmarCodigoBarras(
         ...
         If identificacionDeUsuario.ToString().Length > 8 Then
         ...
         If identificadorDeConcepto < 1 OrElse identificadorDeConcepto > 9 Then
            Throw New ArgumentException("La Identificación de Concepto debe estar comprendido entre 1 y 9.")
         End If
         ...
         Dim identificadorDeUsuario As String = identificacionDeUsuario.ToString("00000000")
         ...
         Dim importeVencimiento1 As String = If(importeVenc1.HasValue, importeVenc1.Value, 0).ToString("00000.00").Replace(".", "").Replace(",", "")
         Dim diasHastaVencimiento2 As String = diasHastaVenc2.Value.ToString("00")
         Dim importeVencimiento2 As String = If(importeVenc2.HasValue, importeVenc2.Value, 0).ToString("00000.00").Replace(".", "").Replace(",", "")
         Dim diasHastaVencimiento3 As String = diasHastaVenc3.Value.ToString("00")
         Dim importeVencimiento3 As String = If(importeVenc3.HasValue, importeVenc3.Value, 0).ToString("00000.00").Replace(".", "").Replace(",", "")


         Dim _identificadorDeCuenta As String = identificadorCuenta.ToString("0000000000") ' Otorgado por ROELA. Longitud 10. NO VARIA.

         ' # Concantenación de Todos los Valores
         Dim temp As String = String.Concat(empresaDeServicio,
                                            identificadorDeConcepto,
         ...
         Dim rDigitoVerificador As Ayudante.DigitosVerificadores.IDAutomationHL25 = New Ayudante.DigitosVerificadores.IDAutomationHL25()
