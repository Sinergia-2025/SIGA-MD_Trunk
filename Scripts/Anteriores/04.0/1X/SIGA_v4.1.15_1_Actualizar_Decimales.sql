...
ALTER TABLE ContabilidadAsientosCuentas ALTER COLUMN Debe decimal(14,4) NULL;
ALTER TABLE ContabilidadAsientosCuentas ALTER COLUMN Haber decimal(14,4) NULL;

ALTER TABLE ContabilidadAsientosCuentasTmp ALTER COLUMN Debe decimal(14,4) NULL;
ALTER TABLE ContabilidadAsientosCuentasTmp ALTER COLUMN Haber decimal(14,4) NULL;
