...
--        SET NOCOUNT ON;
--        UPDATE Clientes
--           SET Clientes.FechaActualizacion = GETDATE()
--        FROM inserted
...
--           SET ProductosSucursales.FechaActualizacion = GETDATE()
--        FROM inserted
...
--           SET ProductosSucursalesPrecios.FechaActualizacion = GETDATE()
--        FROM inserted
...
--        SET NOCOUNT ON;
--        UPDATE Productos
--           SET Productos.FechaActualizacion = GETDATE()
--        FROM inserted
...
--        SET NOCOUNT ON;
--        UPDATE Localidades
--           SET Localidades.FechaActualizacion = GETDATE()
--        FROM inserted
...
--        SET NOCOUNT ON;
--        UPDATE Rubros
--           SET Rubros.FechaActualizacion = GETDATE()
--        FROM inserted
...
--        SET NOCOUNT ON;
--        UPDATE SubRubros
--           SET SubRubros.FechaActualizacion = GETDATE()
--        FROM inserted
...
--        SET NOCOUNT ON;
--        UPDATE SubSubRubros
--           SET SubSubRubros.FechaActualizacion = GETDATE()
--        FROM inserted
...
--        SET NOCOUNT ON;
--        UPDATE ProductosWeb
--           SET ProductosWeb.FechaActualizacion = GETDATE()
--        FROM inserted
