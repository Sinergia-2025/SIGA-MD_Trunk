...
ALTER TABLE dbo.ContabilidadAsientos
	ADD TipoAsiento varchar(50) NULL
GO
UPDATE ContabilidadAsientos SET TipoAsiento = 'NORMAL'

ALTER TABLE dbo.ContabilidadAsientosTmp
	ADD TipoAsiento varchar(50) NULL
GO
UPDATE ContabilidadAsientosTmp SET TipoAsiento = 'NORMAL'
