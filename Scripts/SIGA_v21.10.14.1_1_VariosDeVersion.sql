    ...
    BEGIN
        ...
        USING (
                SELECT IdEmpresa, 
                    ...
                    'https://www.buyerwe.com/wp-json/wc/v3/' ValorParametro, 
    ...
    BEGIN
        ...
        USING (
                SELECT IdEmpresa, 
                    ...
                    'ck_7ef02c10689740334145dce9566959358e23045c' ValorParametro, 
                    'Tienda Arborea' CategoriaParametro, 
    ...
    BEGIN
        ...
        USING (
                SELECT IdEmpresa, 
                    ...
                    'cs_df06085f2fdbb3bdad027588fbc7b61f6ccd545b' ValorParametro, 
                    'Tienda Arborea' CategoriaParametro, 
