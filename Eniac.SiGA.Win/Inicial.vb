Public NotInheritable Class Inicial

   'TODO: Este formulario se puede establecer fácilmente como pantalla de bienvenida para 
   'la aplicación desde la ficha "Aplicación"
   '  del Diseñador de proyectos ("Propiedades" bajo el menú "Proyecto").


    Private Sub Inicial_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
