...
Namespace JSonEntidades.Archivos.CRM
   Public Class CRMMedioComunicacionNovedadJSon
      Inherits Entidades.CRMMedioComunicacionNovedad
   ...
   Public Class CRMMedioComunicacionNovedadJSonTransporte
      ...
      Public Sub New(cuitEmpresa As String, idMedioComunicacionNovedad As Integer, fechaActualizacion As String)
         Me.CuitEmpresa = cuitEmpresa
         Me.IdMedioComunicacionNovedad = idMedioComunicacionNovedad
