...
Public Class PedidosObservacionesProveedores
   ...
   Public Sub PedidosObservacionesProveedores_I(idSucursal As Integer,
      ...
      With myQuery
         .AppendLine("INSERT INTO PedidosObservacionesProveedores ")
      ...
      Me.Sincroniza_I(myQuery.ToString(), "PedidosObservacionesProveedores")
   End Sub

   Public Sub PedidosObservacionesProveedores_U(idSucursal As Integer,
                                     idTipoComprobante As String,
                                     letra As String,
                                     centroEmisor As Integer,
                                     numeroPedido As Long,
      ...
      Dim myQuery As StringBuilder = New StringBuilder()
      With myQuery
         .AppendFormat("UPDATE PedidosObservacionesProveedores SET ").AppendLine()
   ...
   Public Sub PedidosObservacionesProveedores_D(idSucursal As Integer,
                                     idTipoComprobante As String,
                                     letra As String,
                                     centroEmisor As Integer,
                                     numeroPedido As Long,
      ...
      Dim myQuery As StringBuilder = New StringBuilder()
      With myQuery
         .AppendLine("DELETE FROM PedidosObservacionesProveedores ")
         .AppendFormat(" WHERE IdSucursal = {0}", idSucursal).AppendLine()
         .AppendFormat("   AND idTipoComprobante = '{0}'", idTipoComprobante).AppendLine()
         .AppendFormat("   AND Letra = '{0}'", letra).AppendLine()
         .AppendFormat("   AND CentroEmisor = {0}", centroEmisor).AppendLine()
   ...
   Private Sub SelectTexto(ByVal stb As StringBuilder)
      With stb
         ...
         .AppendFormat("  FROM PedidosObservacionesProveedores AS PO").AppendLine()
      End With
   End Sub

   Public Function PedidosObservacionesProveedores_GA(idSucursal As Integer,
                                           idTipoComprobante As String,
                                           letra As String,
                                           centroEmisor As Integer,
                                           numeroPedido As Long) As DataTable
      Return PedidosObservacionesProveedores_G(idSucursal,
                                    idTipoComprobante,
                                    letra,
                                    centroEmisor,
                                    numeroPedido,
                                    0)
   End Function
   Private Function PedidosObservacionesProveedores_G(idSucursal As Integer,
                                            idTipoComprobante As String,
                                            letra As String,
                                            centroEmisor As Integer,
                                            numeroPedido As Long,
   ...
   Public Function PedidosObservacionesProveedores_G1(idSucursal As Integer,
                                           idTipoComprobante As String,
                                           letra As String,
                                           centroEmisor As Integer,
                                           numeroPedido As Long,
   ...
   Public Sub CopiarPedidoObservacion(idSucursal As Integer, idTipoComprobante As String, letra As String, centroEmisor As Integer, numeroPedido As Long,
      ...
      Dim myQuery As StringBuilder = New StringBuilder()
      With myQuery
         .AppendFormat("INSERT INTO PedidosObservacionesProveedores").AppendLine()
         ...
         .AppendFormat("      ,Linea").AppendLine()
         .AppendFormat("      ,Observacion").AppendLine()
         .AppendFormat("  FROM PedidosObservacionesProveedores").AppendLine()
         .AppendFormat(" WHERE IdSucursal = {0}", idSucursal).AppendLine()
         .AppendFormat("   AND IdTipoComprobante = '{0}'", idTipoComprobante).AppendLine()
         .AppendFormat("   AND Letra = '{0}'", letra).AppendLine()
         .AppendFormat("   AND CentroEmisor = {0}", centroEmisor).AppendLine()
