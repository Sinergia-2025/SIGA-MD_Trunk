...
Public Class VentasChequesRechazados
   Inherits Comunes
   ...
   Public Sub VentasChequesRechazados_I(ByVal IdSucursal As Integer,
      ...
      With stb
         .Append("INSERT INTO VentasChequesRechazados (")
         .Append("           IdSucursal")
   ...
   Public Sub VentasChequesRechazados_D(ByVal IdSucursal As Integer,
                                        ByVal IdTipoComprobante As String,
                                        ByVal Letra As String,
                                        ByVal CentroEmisor As Integer,
                                        ByVal NumeroComprobante As Long,
                                        ByVal idCheque As Long)

      Dim stb As StringBuilder = New StringBuilder("")

      With stb
         .Append("DELETE FROM VentasChequesRechazados ")
         .Append(" WHERE ")
   ...
   Public Sub VentasChequesRechazados_D2(ByVal IdSucursal As Integer,
                                         ByVal IdTipoComprobante As String,
                                         ByVal Letra As String,
                                         ByVal CentroEmisor As Integer,
                                         ByVal NumeroComprobante As Long)
   ...
   Private Sub SelectTexto(ByVal stb As StringBuilder)
      With stb
         ...
         .Append("      ,VC.IdCheque")
         .Append("  FROM VentasChequesRechazados VC")
      End With
   End Sub

   Public Function VentasChequesRechazados_GA() As DataTable
      Dim stb As StringBuilder = New StringBuilder("")
      With stb
         Me.SelectTexto(stb)
         '.Append("  ORDER BY VP.")
   ...
   Public Function VentasChequesRechazados_G1(ByVal IdSucursal As Integer,
                                              ByVal IdTipoComprobante As String,
                                              ByVal Letra As String,
                                              ByVal CentroEmisor As Integer,
                                              ByVal NumeroComprobante As Long,
